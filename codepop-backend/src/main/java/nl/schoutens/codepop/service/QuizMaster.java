...
/**
 * Interface for quiz question generation.
 * Implementations should generate unique questions that don't duplicate existing content.
 */
public interface QuizMaster {
     ...
     * @param existingQuestionTexts List of question texts that already exist in the database.
     *                              The implementation should generate questions that are different from these.
